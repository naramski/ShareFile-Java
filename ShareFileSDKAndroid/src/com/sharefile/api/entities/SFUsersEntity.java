...
public class SFUsersEntity extends SFODataEntityBase
{
    ...
    */
	public SFApiQuery<SFUser> get(String id , String emailAddress )
	{
	...
	* @return The new user
    */
	public SFApiQuery<SFUser> create(SFUser user, Boolean pushCreatorDefaultSettings , Boolean addshared , Boolean notify , Boolean ifNecessary )
	{
		SFApiQuery<SFUser> query = new SFApiQuery<SFUser>();
		query.setFrom("Users");
    ...
    */
	public SFApiQuery<SFUser> createAccountUser(SFAccountUser user, Boolean pushCreatorDefaultSettings , Boolean addshared , Boolean notify , Boolean ifNecessary )
	{
		SFApiQuery<SFUser> query = new SFApiQuery<SFUser>();
		query.setFrom("Users");
	...
	* @return a modified user record
    */
	public SFApiQuery<SFUser> updateRoles( String id , SFUser user, String parentid)
	{
		SFApiQuery<SFUser> query = new SFApiQuery<SFUser>();
		query.setFrom("Users");
	...
	* @return a modified user record
    */
	public SFApiQuery<SFUser> addRoles( String id , SFUser user, String parentid)
	{
		SFApiQuery<SFUser> query = new SFApiQuery<SFUser>();
		query.setFrom("Users");
		query.setAction("Roles");
    ...
    */
	public SFApiQuery<SFUser> resetPassword(String id, SFODataObject properties, Boolean notify)
	{
		SFApiQuery<SFUser> query = new SFApiQuery<SFUser>();
		query.setFrom("Users");
	...
	* @param completely 	
    */
	public SFApiQuery delete(String id, Boolean completely)
	{
		SFApiQuery query = new SFApiQuery();
		query.setFrom("Users");
		query.addIds(id);
