...
import com.sharefile.mobile.shared.NTLMWebView.SFWebloginInterface;
...
public class SFReLoginActivity extends Activity implements SFWebloginInterface, GetWebAuthAccessTokenCallback
{	
	private WebView m_webViewLogin = null;
	private ProgressBar mThrobber = null;	
	protected boolean isLimitedMode = false;
	public static final int READ_THIS = 0;
	/**
